    ...
    $scope.caseParam = {
      ...
      form: {
        items: [
          ...
          { name: 'projtype', title: '项目类型', type: 'dropdown', show: { autohide: "empty" }, param: { list: "stee-项目类别", placeholder: "请选择" } },
          { name: 'steetype', title: '钢构类别', type: 'dropdown', show: { autohide: "zero length" }, param: { list: "stee-擅长构件", placeholder: "请选择" } },
          ...
          { name: 'projprize', title: '获奖', type: 'combobox', show: { autohide: "empty" }, param: { list: "stee-业绩获奖", placeholder: "在此输入获奖名称" } },
          { name: 'projclass', title: '工法', type: 'dropdown', show: { autohide: "empty" }, param: { list: "stee-业绩工法", placeholder: "请选择" } },
